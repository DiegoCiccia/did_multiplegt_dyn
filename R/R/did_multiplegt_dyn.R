...
#' @param normalized_weights (logical, requires normalized = TRUE) the command reports the weights that normalized effect \eqn{\ell} puts on the effect of the current treatment, on the effect of the first treatment lag, etc.
...
#' @param bootstrap (integer) This option allows to bootstrap the standard errors of the estimated coefficients. The argument is the number of bootstrap replications.
#' @section Overview:
...
#' 
#' de Chaisemartin, C, Ciccia, D, D'Haultfoeuille, X, Knau, F, Malézieux, M, Sow, D (2024). [Estimators and Variance Estimators Computed by the did_multiplegt_dyn Command](https://drive.google.com/file/d/1d23jtOT8tiHG3mpjD_cuJy3h4I2sYFEK/view?usp=drive_link).
#' 
#' @examples
