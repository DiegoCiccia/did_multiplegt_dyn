...
This version addresses rJava issues in Linux terminals by shutting down the the excel print features built in the **design** and **date_first_switch** options. 
